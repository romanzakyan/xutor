...
$( window ).resize(function() {
	if($( window ).width() < 500){
		$('.div_1').css('height', '100%');
		$('.div_2').css('height', '100%');
		$('.div_3').css('height', '100%');
		$('.b_0').css('position', 'unset');
		$('.b_1').css('position', 'unset');
		$('.b_2').css('position', 'unset');
	}else{
	$('.div_1').css('height', '530px');
...
$(window).scroll(function (event) {
	...
	if(scroll == 0){
		$('#head_').css('padding-top', '35px');
		$('#head_').css('height', '79px');
		$('#head_').css('width', '210px');
	}else{
		$('#head_').css('transition', 'padding-top 0.3s ease');
		$('#head_').css('padding-top', '30px');
		$('#head_').css('transition', 'height 0.3s ease');
		$('#head_').css('height', '68px');
		$('#head_').css('transition', 'width 0.3s ease');
		$('#head_').css('width', '195px');		
	}
});

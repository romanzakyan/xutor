(function () {
    var DEBUG = !1, HOST = DEBUG ? "http://test.yumprint.com" : "http://yumprint.com",
        ...
        SECURE_API_HOST = DEBUG ? "https://testapi.yumprint.com" : "https://api.yumprint.com", ANIMATION_TIME = 200,
        MESSAGE_TIME = 1E3,
    ...
    (function (a, e) {
        ...
        function d(n, a, b) {
            if (j.acceptData(n)) {
                var c, f, d, h = n.nodeType, g = h ? j.cache : n, e = h ? n[j.expando] : j.expando;
                if (g[e]) {
                    ...
                    h ? j.cleanData([n],
                        !0) : j.support.deleteExpando || g != g.window ? delete g[e] : g[e] = null
                }
            }
        }

        function g(n, a, b) {
            if (b === e && 1 === n.nodeType) if (b = "data-" + a.replace(Fb, "-$1").toLowerCase(), b = n.getAttribute(b), "string" === typeof b) {
                try {
        ...
        function p(n) {
            var a = rc.split("|"), n = n.createDocumentFragment();
        ...
        function v(n, a) {
            if (1 === a.nodeType && j.hasData(n)) {
                var b, c, f;
                c = j._data(n);
                var d = j._data(a, c), h = c.events;
                if (h) for (b in delete d.handle, d.events = {}, h) {
                    c = 0;
        ...
        function x(n, a) {
            if (a in n) return a;
            for (var b = a.charAt(0).toUpperCase() + a.slice(1), c = a, f = sc.length; f--;) if (a = sc[f] +
                    b, a in n) return a;
            return c
        }
        ...
        function I(n, a) {
            for (var b, c, f, d = [], h = 0, g = n.length; h < g; h++) if (c = n[h], c.style) if (d[h] = j._data(c, "olddisplay"), b = c.style.display, a) !d[h] && "none" === b && (c.style.display = ""), "" === c.style.display && B(c) && (d[h] = j._data(c, "olddisplay", L(c.nodeName))); else if (!d[h] && (f = B(c), b && "none" !== b || !f)) j._data(c, "olddisplay", f ? b : j.css(c, "display"));
            for (h = 0; h < g; h++) if (c = n[h], c.style && (!a || "none" === c.style.display ||
        ...
        function C(n, a, b) {
            var c =
                    !0, f = "width" === a ? n.offsetWidth : n.offsetHeight, d = Ca(n),
        ...
        function M(n, a) {
            var b = j(a.createElement(n)).appendTo(a.body), c = j.css(b[0], "display");
            b.remove();
            return c
        }
        ...
        function da(n, a, b, c) {
            ...
            }); else if (!b && "object" === j.type(a)) for (f in a) da(n + "[" + f + "]", a[f], b, c); else c(n, a)
        }
        ...
        function K(n) {
            return function (a, b) {
                "string" !==
                typeof a && (b = a, a = "*");
                var c, f = 0, d = a.toLowerCase().match(ia) || [];
        ...
        function ma(n, a, b) {
            var c, f, d = 0, h = kb.length, g = j.Deferred().always(function () {
                delete e.elem
            }), e = function () {
                if (f) return !1;
                ...
                g.promise({
                    ...
                    stop: function (a) {
                        var b = 0, c = a ? k.tweens.length : 0;
                        if (f) return this;
                        for (f = !0; b < c; b++) k.tweens[b].run(1);
                        a ? g.resolveWith(n, [k, a]) : g.rejectWith(n, [k, a]);
                        return this
                    }
                }), a = k.props, b = k.opts.specialEasing, l, m, s, p;
            for (c in a) if (m =
                    j.camelCase(c), s = b[m], l = a[c], j.isArray(l) && (s = l[1], l = a[c] = l[0]), c !== m && (a[m] = l, delete a[c]), (p = j.cssHooks[m]) && "expand" in p) for (c in l = p.expand(l), delete a[m], l) c in a || (a[c] = l[c], b[c] = s); else b[m] = s;
        ...
        var W, aa, E = typeof e, A = a.document, J = a.location, ba = a.jQuery, ka = a.$, P = {}, wa = [],
            lb = wa.concat, Wa = wa.push, ta = wa.slice, mb = wa.indexOf, Jb = P.toString, Ea = P.hasOwnProperty, Xa =
                "1.9.1".trim, j = function (n, a) {
                return new j.fn.init(n, a, aa)
            }, Ia = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, ia = /\S+/g, Kb = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,
            Lb = /^(?:(<[\w\W]+>)[^>]*|#([\w-]*))$/, nb = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Mb = /^[\],:{}\s]*$/,
            Nb = /(?:^|:|,)(?:\s*\[)+/g, Ob = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g,
            Pb = /"[^"\\\r\n]*"|true|false|null|-?(?:\d+\.|)\d+(?:[eE][+-]?\d+|)/g, Qb = /^-ms-/, Rb = /-([\da-z])/gi,
            Sb = function (n, a) {
        ...
        j.fn = j.prototype = {
            jquery: "1.9.1", constructor: j, init: function (n, a, b) {
                var c;
                if (!n) return this;
                if ("string" === typeof n) {
                    if ((c = "<" === n.charAt(0) && ">" === n.charAt(n.length - 1) && 3 <= n.length ? [null, n, null] : Lb.exec(n)) && (c[1] || !a)) {
                        if (c[1]) {
                            if (a = a instanceof j ? a[0] : a, j.merge(this, j.parseHTML(c[1],
                                    a && a.nodeType ? a.ownerDocument || a : A, !0)), nb.test(c[1]) && j.isPlainObject(a)) for (c in a) if (j.isFunction(this[c])) this[c](a[c]); else this.attr(c, a[c])
                        } else {
        ...
        j.extend = j.fn.extend = function () {
            var a, b, c, f, d, h = arguments[0] || {}, g = 1, k = arguments.length, l = !1;
            "boolean" === typeof h && (l = h, h = arguments[1] || {}, g = 2);
            "object" !==
            typeof h && !j.isFunction(h) && (h = {});
            k === g && (h = this, --g);
            for (; g < k; g++) if (null != (d = arguments[g])) for (f in d) a = h[f], c = d[f], h !== c && (l && c && (j.isPlainObject(c) || (b = j.isArray(c))) ? (b ? (b = !1, a = a && j.isArray(a) ? a : []) : a = a && j.isPlainObject(a) ? a : {}, h[f] = j.extend(l, a, c)) : c !== e && (h[f] = c));
            return h
        };
        j.extend({
            noConflict: function (n) {
                ...
                d = c(a);
                if (f) if (d) for (; h < g && !(d = b.apply(a[h], f), !1 === d); h++) ; else for (h in a) {
                    if (d = b.apply(a[h],
                            f), !1 === d) break
                } else if (d) for (; h < g && !(d = b.call(a[h], h, a[h]), !1 === d); h++) ; else for (h in a) if (d = b.call(a[h], h, a[h]), !1 === d) break;
                return a
                ...
                if (b) {
                    ...
                    f = b.length;
                    for (c = c ? 0 > c ? Math.max(0, f + c) : c : 0; c < f; c++) if (c in
                        b && b[c] === a) return c
                }
                return -1
            }, merge: function (a, b) {
                var c = b.length, f = a.length, d = 0;
                if ("number" === typeof c) for (; d < c; d++) a[f++] = b[d]; else for (; b[d] !== e;) a[f++] = b[d++];
                a.length = f;
                return a
            }, grep: function (a, b, c) {
                ...
                var d, h = 0, g = a.length, e = [];
                if (c(a)) for (; h < g; h++) d = b(a[h], h, f), null != d && (e[e.length] = d); else for (h in a) d = b(a[h], h, f), null != d && (e[e.length] = d);
                return lb.apply([], e)
                ...
                var k = 0, l = a.length, m = null == c;
                if ("object" === j.type(c)) for (k in d = !0, c) j.access(a, b, k, c[k], !0, h, g); else if (f !== e && (d = !0, j.isFunction(f) || (g = !0), m && (g ? (b.call(a, f), b = null) : (m = b, b = function (a, n, b) {
                        return m.call(j(a), b)
                    })), b)) for (; k < l; k++) b(a[k], c, g ? f : f.call(a[k], k, b(a[k],
                    c)));
        ...
        j.ready.promise = function (n) {
            if (!W) if (W = j.Deferred(), "complete" === A.readyState) setTimeout(j.ready); else if (A.addEventListener) A.addEventListener("DOMContentLoaded", na, !1), a.addEventListener("load", na, !1); else {
        ...
        j.Callbacks = function (a) {
            ...
            var a = b, f, d, h, g, k, l, m = [], s = !a.once && [], p = function (b) {
                d = a.memory && b;
                h = !0;
                k = l || 0;
                l = 0;
                g = m.length;
                for (f = !0; m && k < g; k++) if (!1 === m[k].apply(b[0], b[1]) &&
                    a.stopOnFalse) {
                    d = !1;
                    break
                }
        ...
        j.extend({
            Deferred: function (a) {
                var b = [["resolve", "done", j.Callbacks("once memory"), "resolved"], ["reject", "fail",
                        j.Callbacks("once memory"), "rejected"], ["notify", "progress", j.Callbacks("memory")]],
                    c = "pending", f = {
                        state: function () {
                            return c
                        }, always: function () {
                            ...
                            return j.Deferred(function (n) {
                                j.each(b, function (b, c) {
                                    var h = c[0], g = j.isFunction(a[b]) && a[b];
                                    d[c[1]](function () {
                                        var a = g && g.apply(this, arguments);
                                        if (a && j.isFunction(a.promise)) a.promise().done(n.resolve).fail(n.reject).progress(n.notify); else n[h + "With"](this === f ? n.promise() : this,
                                            g ? [a] : arguments)
                                    })
                                });
                                a = null
                ...
                var b = 0, c = ta.call(arguments), f = c.length, d = 1 !== f || a && j.isFunction(a.promise) ? f : 0,
                    h = 1 === d ? a : j.Deferred(), g = function (a, n, b) {
                        return function (c) {
                            n[a] =
                                this;
        ...
        if (!Ja || !oa || !Ja.length) Ya = {}; else {
            ...
            for ($a in{submit: !0, change: !0, focusin: !0}) D.setAttribute(Za =
        ...
        j.extend({
            queue: function (a, b, c) {
                ...
                var b = b || "fx", c = j.queue(a, b), f = c.length, d = c.shift(), h = j._queueHooks(a, b),
                    g = function () {
                        j.dequeue(a, b)
                    };
        ...
        j.fn.extend({
            queue: function (a, b) {
                ...
                var c, f = 1, d = j.Deferred(), h = this, g = this.length, k = function () {
                    --f || d.resolveWith(h, [h])
                };
        ...
        var xa, rb, ab = /[\t\r\n]/g, Ub = /\r/g, Vb = /^(?:input|select|textarea|button|object)$/i,
            ...
            bb = /^(?:checked|selected)$/i, ua = j.support.getSetAttribute, cb = j.support.input;
        j.fn.extend({
            attr: function (a, b) {
                ...
                var b, c, f, d, h, g = 0, e = this.length;
                b = "string" === typeof a && a;
                if (j.isFunction(a)) return this.each(function (b) {
                    j(this).addClass(a.call(this, b, this.className))
                });
                if (b) for (b = (a || "").match(ia) || []; g < e; g++) if (c = this[g], f = 1 === c.nodeType && (c.className ? (" " + c.className + " ").replace(ab, " ") : " ")) {
                ...
                var c = typeof a, f = "boolean" === typeof b;
                return j.isFunction(a) ? this.each(function (c) {
                    j(this).toggleClass(a.call(this,
                        c, this.className, b), b)
                }) : this.each(function () {
                    if ("string" === c) for (var d, h = 0, g = j(this), e = b, k = a.match(ia) || []; d = k[h++];) e = f ? e : !g.hasClass(d), g[e ? "addClass" : "removeClass"](d); else if (c === E || "boolean" === c) this.className && j._data(this, "__className__", this.className), this.className = this.className || !1 === a ? "" : j._data(this, "__className__") || ""
                })
            }, hasClass: function (a) {
        ...
        j.extend({
            valHooks: {
                option: {
                    ...
                    get: function (a) {
                        for (var b, c = a.options, f = a.selectedIndex, d = (a = "select-one" === a.type || 0 > f) ? null : [], h = a ? f + 1 : c.length, g = 0 > f ? h : a ? f : 0; g < h; g++) if (b = c[g], (b.selected || g === f) && (j.support.optDisabled ? !b.disabled : null === b.getAttribute("disabled")) && (!b.parentNode.disabled || !j.nodeName(b.parentNode, "optgroup"))) {
                            b =
                                j(b).val();
                            if (a) return b;
                            d.push(b)
            ...
            attr: function (a, b, c) {
                ...
                if (a && !(3 === d || 8 === d || 2 === d)) {
                    ...
                    if (c !== e) if (null === c) j.removeAttr(a, b); else {
        ...
        rb = {
            get: function (a, b) {
                var c = j.prop(a, b), f = "boolean" === typeof c && a.getAttribute(b);
        ...
        if (!cb || !ua) j.attrHooks.value = {
            get: function (a, b) {
                ...
                if (j.nodeName(a, "input")) a.defaultValue = b; else return xa && xa.set(a, b, c)
            }
        };
        ...
        var db = /^(?:input|select|textarea)$/i, Xb = /^key/, Yb = /^(?:mouse|contextmenu)|click/,
            tb = /^(?:focusinfocus|focusoutblur)$/, ub = /^([^.]*)(?:\.(.+)|)$/;
        j.event = {
            global: {},
            add: function (a,
                           b, c, f, d) {
            ...
            remove: function (a, b, c, f, d) {
                ...
                if (C && (m = C.events)) {
                    b = (b || "").match(ia) || [""];
                    for (l = b.length; l--;) if (e = ub.exec(b[l]) || [], w = t = e[1], z = (e[2] || "").split(".").sort(), w) {
                        s = j.event.special[w] || {};
                        w = (f ? s.delegateType : s.bindType) || w;
                        p = m[w] || [];
                        e = e[2] && RegExp("(^|\\.)" + z.join("\\.(?:.*\\.|)") + "(\\.|$)");
                        for (k = h = p.length; h--;) if (g = p[h], (d || t === g.origType) && (!c || c.guid === g.guid) && (!e || e.test(g.namespace)) && (!f || f === g.selector || "**" === f && g.selector)) p.splice(h, 1), g.selector && p.delegateCount--, s.remove && s.remove.call(a, g);
                        k && !p.length &&
            ...
            trigger: function (b, c, f, d) {
                var h, g, k, l, m, s, p = [f || A], w = Ea.call(b, "type") ? b.type : b;
                m = Ea.call(b, "namespace") ? b.namespace.split(".") : [];
                k = h = f = f || A;
                if (!(3 === f.nodeType || 8 === f.nodeType) && !tb.test(w + j.event.triggered)) if (0 <= w.indexOf(".") && (m = w.split("."), w = m.shift(), m.sort()), g = 0 > w.indexOf(":") && "on" +
                    ...
                    for (s = 0; (k = p[s++]) && !b.isPropagationStopped();) b.type = 1 < s ? l : m.bindType || w, (h = (j._data(k, "events") || {})[b.type] && j._data(k, "handle")) && h.apply(k, c), (h = g && k[g]) && (j.acceptData(k) && h.apply && !1 === h.apply(k, c)) && b.preventDefault();
                    b.type = w;
            ...
            dispatch: function (a) {
                var a = j.event.fix(a), b, c, f, d, h = [], g = ta.call(arguments);
                ...
                if (!(k.preDispatch && !1 === k.preDispatch.call(this, a))) {
                    ...
                    for (b = 0; (f = h[b++]) && !a.isPropagationStopped();) {
                        ...
                        for (d = 0; (c = f.handlers[d++]) && !a.isImmediatePropagationStopped();) if (!a.namespace_re || a.namespace_re.test(c.namespace)) if (a.handleObj = c, a.data = c.data, c = ((j.event.special[c.origType] ||
                                {}).handle || c.handler).apply(f.elem, g), c !== e && !1 === (a.result = c)) a.preventDefault(), a.stopPropagation()
                    }
            ...
            handlers: function (a, b) {
                var c, f, d, h, g = [], k = b.delegateCount, l = a.target;
            ...
            mouseHooks: {
                ...
                filter: function (a, b) {
                    var c, f, d = b.button, h = b.fromElement;
                    null ==
            ...
            special: {
                load: {noBubble: !0}, click: {
                    trigger: function () {
                        if (j.nodeName(this, "input") && "checkbox" === this.type && this.click) return this.click(),
                            !1
                    }
                }, focus: {
                    trigger: function () {
        ...
        j.each({mouseenter: "mouseover", mouseleave: "mouseout"}, function (a, b) {
            j.event.special[a] = {
                delegateType: b, bindType: b, handle: function (a) {
                    var c, f = a.relatedTarget, d = a.handleObj;
        ...
        j.fn.extend({
            on: function (a, b, c, f, d) {
                ...
                if (!1 === f) f = h; else if (!f) return this;
        ...
        var eb = a, fb = function () {
                ...
                if (!la && !f) {
                    if (d = Yc.exec(a)) if (g = d[1]) if (9 === e) if ((h = b.getElementById(g)) && h.parentNode) {
                ...
                a:{
                    ...
                    if (!f && 1 === h.length) {
                        ...
                        for (e = wb.needsContext.test(a) ? 0 : d.length; e--;) {
                            ...
                            if (g = F.find[g]) if (f = g(l.matches[0].replace(ya, za), Zb.test(d[0].type) && b.parentNode || b)) {
                                d.splice(e, 1);
                                a = f.length && Z(d);
                                if (!a) {
                ...
                var c = b && a, f = c && (~b.sourceIndex || vc) - (~a.sourceIndex || vc);
                if (f) return f;
                ...
                for (k = F.preFilter; g;) {
                    ...
                    for (h in F.filter) if ((f = wb[h].exec(g)) && (!k[h] || (f = k[h](f)))) c = f.shift(), d.push({
                        value: c,
                        type: h,
                        matches: f
                    }), g = g.slice(c.length);
                ...
                var f = b.dir, d = c && "parentNode" === f, h = bd++;
                return b.first ? function (b, c, h) {
                    ...
                    } else for (; b = b[f];) if (1 === b.nodeType || d) if (j = b[Q] || (b[Q] = {}), (k = j[f]) && k[0] === l) {
                ...
                var b, c, f, d = a.length, h = F.relative[a[0].type];
                c = h || F.relative[" "];
                ...
                }]; g < d; g++) if (c = F.relative[a[g].type]) j = [cc(dc(j), c)]; else {
            ...
            Fa = eb.document, T = {}, ra = 0, bd = 0, zc = fb(), wc = fb(), Ac = fb(), vc = -2147483648,
            Db = [], cd = Db.pop, Oa = Db.push, Pa = Db.slice, fc = Db.indexOf || function (a) {
            ...
            }, Zb = /[\x20\t\r\n\f]*[+~]/, jc = /^[^{]+\{\s*\[native code/, Yc = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            fd = /^(?:input|select|textarea|button)$/i, gd = /^h\d$/i, Zc = /'|\\/g,
        ...
        Na = H.setDocument = function (a) {
            ...
            F.find.TAG = T.tagNameNoComments ? function (a, b) {
                ...
                var c, f = [], d = 0, h = b.getElementsByTagName(a);
                if ("*" === a) {
            ...
            gb = jc.test(fa.contains + "") || fa.compareDocumentPosition ? function (a, b) {
                var c = 9 ===
                a.nodeType ? a.documentElement : a, f = b && b.parentNode;
        ...
        F = H.selectors = {
            ...
            preFilter: {
                ATTR: function (a) {
                    ...
                    if (a[4]) a[2] = a[4]; else if (c && dd.test(c) && (b = va(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length)) a[0] = a[0].slice(0, b), a[2] = c.slice(0, b);
                    return a.slice(0, 3)
                }
            },
            filter: {
                TAG: function (a) {
                    ...
                    var h = "nth" !== a.slice(0,
                        3), g = "last" !== a.slice(-4), e = "of-type" === b;
                    return 1 === f && 0 === d ? function (a) {
                        return !!a.parentNode
                    } : function (b, c, k) {
                        var j, l, m, s, R, c = h !== g ? "nextSibling" : "previousSibling", p = b.parentNode,
                            S = e && b.nodeName.toLowerCase(), k = !k && !e;
                        if (p) {
                            if (h) {
                                for (; c;) {
                            ...
                            if (g && k) {
                                ...
                                for (l = s && p.childNodes[s]; l = ++s && l && l[c] ||
                                    (m = s = 0) || R.pop();) if (1 === l.nodeType && ++m && l === b) {
                                    k[a] = [ra, s, m];
                                    break
                                }
                            } else if (k && (j = (b[Q] || (b[Q] = {}))[a]) && j[0] === ra) m = j[1]; else for (; l = ++s && l && l[c] || (m = s = 0) || R.pop();) if ((e ? l.nodeName.toLowerCase() === S : 1 === l.nodeType) && ++m) if (k && ((l[Q] || (l[Q] = {}))[a] = [ra, m]), l === b) break;
                            m -= d;
            ...
            pseudos: {
                ...
                lang: ea(function (a) {
                    ...
                    return function (b) {
                        var c;
                        do if (c = la ? b.getAttribute("xml:lang") || b.getAttribute("lang") : b.lang) return c = c.toLowerCase(), c === a || 0 === c.indexOf(a + "-"); while ((b = b.parentNode) && 1 === b.nodeType);
                        return !1
                    }
                }), target: function (a) {
        ...
        $b = H.compile = function (a, b) {
            ...
            if (!h) {
                ...
                var g = 0, e = 0 < f.length, k = 0 < d.length;
                c = function (a, b, c, h, n) {
                    var j, l, m = [], s = 0, p = "0", R =
                        a && [], w = null != n, S = Ab, z = a || k && F.find.TAG("*", n && b.parentNode || b),
                        t = ra += null == S ? 1 : Math.random() || 0.1;
                    w && (Ab = b !== ca && b, yb = g);
                    for (; null != (n = z[p]); p++) {
                        if (k && n) {
                            for (j = 0; l = d[j++];) if (l(n, b, c)) {
                                h.push(n);
                                break
                            }
                            w && (ra = t, yb = ++g)
        ...
        var id = /Until$/, jd = /^(?:parents|prev(?:Until|All))/, Tc = /^.[^:#\[\.,]*$/, Dc = j.expr.match.needsContext,
        ...
        j.fn.extend({
            find: function (a) {
                ...
                if ("string" !== typeof a) return f = this, this.pushStack(j(a).filter(function () {
                    for (b = 0; b < d; b++) if (j.contains(f[b],
                            this)) return !0
                }));
                c = [];
                ...
                for (var c, f = 0, d = this.length, h = [], g = Dc.test(a) || "string" !== typeof a ? j(a, b || this.context) : 0; f < d; f++) for (c = this[f]; c && c.ownerDocument && c !== b && 11 !== c.nodeType;) {
        ...
        var rc = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            ld = / jQuery\d+="(?:null|\d+)"/g, Ec = RegExp("<(?:" + rc + ")[\\s/>]", "i"), kc = /^\s+/,
            Fc = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Gc = /<([\w:]+)/,
            Hc = /<tbody/i, md = /<|&#?\w+;/, nd = /<(?:script|style|link)/i, Hb = /^(?:checkbox|radio)$/i,
            od = /checked\s*(?:[^=]|=\s*.checked.)/i,
            Ic = /^$|\/(?:java|ecma)script/i, Uc = /^true\/(.*)/, pd = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
            ha = {
        ...
        j.fn.extend({
            text: function (a) {
                ...
                for (var c, f = 0; null != (c = this[f]); f++) if (!a || 0 < j.filter(a, [c]).length) !b && 1 === c.nodeType && j.cleanData(u(c)), c.parentNode && (b && j.contains(c.ownerDocument, c) && r(u(c, "script")), c.parentNode.removeChild(c));
                return this
            }, empty: function () {
                ...
                var a = lb.apply([], a), f, d, h, g, k = 0, l = this.length, m = this, s = l - 1, p = a[0],
                    w = j.isFunction(p);
                if (w || !(1 >= l || "string" !==
                ...
                if (l && (g = j.buildFragment(a, this[0].ownerDocument, !1, this), f = g.firstChild, 1 === g.childNodes.length && (g = f), f)) {
                    ...
                    if (d) {
                        ...
                        j.map(h, q);
                        for (k = 0; k < d; k++) if (f = h[k], Ic.test(f.type || "") && !j._data(f, "globalEval") && j.contains(g, f)) f.src ? j.ajax({
                            url: f.src,
                            type: "GET",
                            dataType: "script",
                            async: !1,
        ...
        j.extend({
            clone: function (a, b, c) {
                ...
                if ((!j.support.noCloneEvent || !j.support.noCloneChecked) && (1 === a.nodeType || 11 === a.nodeType) && !j.isXMLDoc(a)) {
                    f = u(h);
                    e = u(a);
                    for (g = 0; null != (d = e[g]); ++g) if (f[g]) {
                        var l = f[g],
                            m = void 0, s = void 0, p = void 0;
                        if (1 === l.nodeType) {
                            ...
                            if ("script" === m && l.text !== d.text) t(l).text = d.text, q(l); else if ("object" === m) l.parentNode && (l.outerHTML = d.outerHTML), j.support.html5Clone && (d.innerHTML && !j.trim(l.innerHTML)) && (l.innerHTML = d.innerHTML); else if ("input" === m && Hb.test(d.type)) l.defaultChecked = l.checked = d.checked, l.value !== d.value && (l.value =
                                d.value); else if ("option" === m) l.defaultSelected = l.selected = d.defaultSelected; else if ("input" === m || "textarea" === m) l.defaultValue = d.defaultValue
                        }
                    }
                }
                if (b) if (c) {
                ...
                for (var d, h, g, e, k, l, m = a.length, s = p(b), w = [], z = 0; z < m; z++) if ((h = a[z]) || 0 === h) if ("object" === j.type(h)) j.merge(w, h.nodeType ? [h] : h); else if (md.test(h)) {
                    ...
                    if (!j.support.tbody) for (d = (h = "table" === e && !Hc.test(h) ? g.firstChild : "<table>" === l[1] && !Hc.test(h) ? g : 0) && h.childNodes.length; d--;) j.nodeName(k = h.childNodes[d], "tbody") && !k.childNodes.length && h.removeChild(k);
                ...
                for (var c, f, d, h, g = 0, e = j.expando, k = j.cache, l = j.support.deleteExpando, m = j.event.special; null != (c = a[g]); g++) if (b || j.acceptData(c)) if (h = (d = c[e]) && k[d]) {
                    if (h.events) for (f in h.events) m[f] ?
        ...
        var Ua, Ca, Da, mc = /alpha\([^)]*\)/i, qd = /opacity\s*=\s*([^)]*)/, rd = /^(top|right|bottom|left)$/,
            sd = /^(none|table(?!-c[ea]).+)/, Jc = /^margin/, Vc = RegExp("^(" + Ia + ")(.*)$", "i"),
            jb = RegExp("^(" + Ia + ")(?!px)[a-z%]+$", "i"), td = RegExp("^([+-])=(" + Ia + ")", "i"),
            tc = {BODY: "block"}, ud = {position: "absolute", visibility: "hidden", display: "block"},
            Kc = {letterSpacing: 0, fontWeight: 400},
            Ba = ["Top", "Right", "Bottom", "Left"], sc = ["Webkit", "O", "Moz", "ms"];
        j.fn.extend({
            css: function (a, b) {
        ...
        j.extend({
            ...
            style: function (a, b, c, f) {
                if (a && !(3 === a.nodeType || 8 === a.nodeType || !a.style)) {
                    var d, h, g, k = j.camelCase(b), l = a.style, b = j.cssProps[k] || (j.cssProps[k] = x(l, k));
                    g = j.cssHooks[b] || j.cssHooks[k];
                    if (c !== e) {
                        h = typeof c;
                        if ("string" === h && (d = td.exec(c))) c = (d[1] + 1) * d[2] + parseFloat(j.css(a,
                            b)), h = "number";
                        if (!(null == c || "number" === h && isNaN(c))) if ("number" === h && !j.cssNumber[k] && (c += "px"), !j.support.clearCloneStyle && ("" === c && 0 === b.indexOf("background")) && (l[b] = "inherit"), !g || !("set" in g) || (c = g.set(a, c, f)) !== e) try {
                            l[b] = c
                        } catch (m) {
                        }
        ...
        a.getComputedStyle ? (Ca = function (b) {
            ...
            var f, d = (c = c || Ca(a)) ? c.getPropertyValue(b) || c[b] : e, h = a.style;
            ...
            var f, d, h = (c = c || Ca(a)) ? c[b] : e, g = a.style;
            null == h && (g && g[b]) && (h = g[b]);
        ...
        j.support.opacity || (j.cssHooks.opacity = {
            get: function (a, b) {
                ...
                var c = a.style, f = a.currentStyle, d = j.isNumeric(b) ? "alpha(opacity=" + 100 * b + ")" : "",
                    h = f && f.filter ||
                        c.filter || "";
                c.zoom = 1;
        ...
        var Ga, Aa, nc = j.now(), oc = /\?/, yd = /#.*$/, Mc = /([?&])_=[^&]*/, zd = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg,
            Ad = /^(?:GET|HEAD)$/,
            Bd = /^\/\//, Nc = /^([\w.+-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, Oc = j.fn.load, Pc = {}, Ib = {},
            Qc = "*/".concat("*");
        try {
            Aa = J.href
        } catch (Hd) {
        ...
        j.fn.load = function (a, b, c) {
            ...
            var f, d, h, g = this, k = a.indexOf(" ");
            0 <= k && (f = a.slice(k, a.length), a = a.slice(0, k));
            j.isFunction(b) ? (c = b, b = e) : b && "object" === typeof b && (h = "POST");
            0 < g.length && j.ajax({url: a, type: h, dataType: "html", data: b}).done(function (a) {
                d =
                    arguments;
        ...
        j.extend({
            active: 0, lastModified: {}, etag: {}, ajaxSettings: {
            ...
            }, ajaxPrefilter: K(Pc), ajaxTransport: K(Ib), ajax: function (a, b) {
                function c(a, b, f, d) {
                    var n, s, q, L, r = b;
                    if (2 !== Z) {
                        Z = 2;
                        ...
                        if (f) {
                            L = p;
                            var d = x, u, R, v, B, da = L.contents, M = L.dataTypes, I = L.responseFields;
                            for (B in I) B in f && (d[I[B]] = f[B]);
                            for (; "*" === M[0];) M.shift(), R === e && (R = L.mimeType || d.getResponseHeader("Content-Type"));
                            if (R) for (B in da) if (da[B] && da[B].test(R)) {
                                M.unshift(B);
                                break
                            }
                            if (M[0] in f) v = M[0]; else {
                                for (B in f) {
                        ...
                        if (200 <= a && 300 > a || 304 === a) if (p.ifModified && ((f = x.getResponseHeader("Last-Modified")) && (j.lastModified[h] = f), (f = x.getResponseHeader("etag")) && (j.etag[h] = f)), 204 === a) n = !0, r = "nocontent"; else if (304 === a) n = !0, r = "notmodified"; else {
                            a:{
                                s = p;
                                q = L;
                                var ib, S, r = {};
                                ...
                                if (R[1]) for (S in s.converters) r[S.toLowerCase()] =
                                    s.converters[S];
                                for (; f = R[++u];) if ("*" !== f) {
                                    if ("*" !== v && v !== f) {
                                        S = r[v + " " + f] || r["* " + f];
                                        if (!S) for (ib in r) if (n = ib.split(" "), n[1] === f && (S = r[v + " " + n[0]] || r["* " + n[0]])) {
                                            !0 === S ? S = r[ib] : !0 !== r[ib] && (f = n[0], R.splice(u--, 0, f));
                                            break
                                        }
                                        if (!0 !== S) if (S && s["throws"]) q = S(q); else try {
                                            q = S(q)
                                        } catch (K) {
                                            n = {
                                                state: "parsererror",
                ...
                var b = b || {}, f, d, h, g, k, l, m, s, p = j.ajaxSetup({}, b), w = p.context || p,
                    z = p.context && (w.nodeType || w.jquery) ? j(w) : j.event, t = j.Deferred(),
                    C = j.Callbacks("once memory"), va = p.statusCode || {}, q = {}, L = {}, Z = 0, r = "canceled",
                    x = {
                        readyState: 0, getResponseHeader: function (a) {
                            ...
                            var b;
                            if (a) if (2 > Z) for (b in a) va[b] = [va[b], a[b]]; else x.always(a[x.status]);
                            return this
                        }, abort: function (a) {
                            a = a || r;
                            m && m.abort(a);
        ...
        var Ta, hb, Cd = 0, qc = a.ActiveXObject && function () {
                ...
                return {
                    send: function (f, d) {
                        ...
                        c = function (a, f) {
                            var g, l, m, p;
                            try {
                                if (c && (f || 4 === k.readyState)) if (c = e, h && (k.onreadystatechange = j.noop, qc && delete Ta[h]), f) 4 !== k.readyState && k.abort(); else {
                                    p = {};
                                    g = k.status;
        ...
        var Ha, Eb, Dd = /^(?:toggle|show|hide)$/, Ed = RegExp("^(?:([+-])=|)(" + Ia + ")([a-z%]*)$", "i"),
            Fd = /queueHooks$/, kb = [function (a, b, c) {
                var f, d, h, g, e, k, l = this, m = a.style, p = {}, s = [], w = a.nodeType && B(a);
                ...
                "*": [function (a, b) {
                    var c, f, d = this.createTween(a, b), h = Ed.exec(b), g = d.cur(), e = +g || 0, k = 1, l = 20;
                    if (h) {
                        c = +h[2];
        ...
        j.Tween = N;
        N.prototype = {
            constructor: N, init: function (a, b, c, f, d, h) {
                this.elem = a;
                this.prop = c;
                this.easing = d || "swing";
                this.options = b;
        ...
        N.propHooks = {
            _default: {
                get: function (a) {
                    ...
                    if (j.fx.step[a.prop]) j.fx.step[a.prop](a); else a.elem.style &&
        ...
        j.fn.extend({
            fadeTo: function (a, b, c, f) {
                ...
                var d = j.isEmptyObject(a), h = j.speed(b, c, f), g = function () {
                ...
                return this.each(function () {
                    var b = !0, d = null != a && a + "queueHooks", h = j.timers, g = j._data(this);
                    if (d) g[d] &&
                    g[d].stop && f(g[d]); else for (d in g) g[d] && (g[d].stop && Fd.test(d)) && f(g[d]);
                ...
                !1 !== a && (a = a || "fx");
                return this.each(function () {
                    var b, c = j._data(this), f = c[a + "queue"];
                    b = c[a + "queueHooks"];
                    var d = j.timers, h = f ? f.length : 0;
                    c.finish = !0;
                    j.queue(this, a, []);
        ...
        j.fn.offset = function (a) {
            ...
            var b, c, f = {top: 0, left: 0}, d = (c = this[0]) && c.ownerDocument;
            if (d) {
                b = d.documentElement;
        ...
        j.offset = {
            setOffset: function (a, b, c) {
                ...
                var d = j(a), h = d.offset(), g = j.css(a, "top"), e = j.css(a, "left"), k = {}, l = {};
                ("absolute" ===
        ...
        j.fn.extend({
            position: function () {
                if (this[0]) {
                    var a, b, c = {top: 0, left: 0}, f = this[0];
    ...
    var $ = window.$.noConflict(!0), jQuery = $;
    (function (a, e) {
        function c(c, d) {
            var g, e;
        ...
        a.fn.extend({
            focus: function (b) {
                ...
                if (this.length) for (var b = a(this[0]), c; b.length && b[0] !== document;) {
                    c = b.css("position");
        ...
        a("<a>").outerWidth(1).jquery || a.each(["Width", "Height"], function (b, c) {
            ...
            var g = "Width" === c ? ["Left", "Right"] : ["Top", "Bottom"], l = c.toLowerCase(), t = {
    ...
    (function (a, e) {
        var c = 0, b = Array.prototype.slice, d = a.cleanData;
        ...
        a.widget = function (b, c, f) {
            var d, e, m, p, t = {}, q = b.split(".")[0], b = b.split(".")[1];
            d = q + "-" + b;
            f || (f = c, c = a.Widget);
            ...
            a.each(f, function (b, f) {
                if (a.isFunction(f)) {
                    ...
                    t[b] = function () {
                        var a = this._super, b = this._superApply, c;
                        this._super = d;
                        this._superApply = h;
            ...
            m.prototype = a.widget.extend(p, {widgetEventPrefix: e ? p.widgetEventPrefix : b}, t, {
                constructor: m,
                namespace: q, widgetName: b, widgetFullName: d
            });
        ...
        a.widget.extend = function (c) {
            for (var d = b.call(arguments, 1), f = 0, h = d.length, k, m; f < h; f++) for (k in d[f]) m = d[f][k], d[f].hasOwnProperty(k) && m !== e && (c[k] = a.isPlainObject(m) ? a.isPlainObject(c[k]) ? a.widget.extend({}, c[k], m) : a.widget.extend({}, m) : m);
            return c
        };
        a.widget.bridge =
            function (c, d) {
                ...
                a.fn[c] = function (h) {
                    var k = "string" === typeof h, m = b.call(arguments, 1), p = this,
        ...
        a.Widget.prototype = {
            ...
            option: function (b, c) {
                ...
                if ("string" === typeof b) if (f = {}, d = b.split("."), b = d.shift(), d.length) {
            ...
            _on: function (b, c, f) {
                ...
                a.each(f, function (f, p) {
                    ...
                    var q = f.match(/^(\w+)\s*(.*)$/), r = q[1] + e.eventNamespace;
            ...
            _trigger: function (b, c, f) {
                var d,
                    e = this.options[b], f = f || {}, c = a.Event(c);
        ...
        a.each({show: "fadeIn", hide: "fadeOut"}, function (b, c) {
            a.Widget.prototype["_" + b] = function (f, d, e) {
                ...
                var m, p = !d ? b : !0 === d || "number" === typeof d ? c : d.effect || c, d =
                    d || {};
                "number" === typeof d && (d = {duration: d});
                m = !a.isEmptyObject(d);
                d.complete = e;
                d.delay && f.delay(d.delay);
                if (m && a.effects && a.effects.effect[p]) f[b](d); else if (p !== b && f[p]) f[p](d.duration, d.easing, e); else f.queue(function (c) {
                    a(this)[b]();
                    e && e.call(f[0]);
                    c()
                })
    ...
    (function (a, e) {
        ...
        a.ui = a.ui || {};
        var b, d = Math.max, g = Math.abs, l = Math.round, f = /left|center|right/, h = /top|center|bottom/,
            k = /[\+\-]\d+(\.[\d]+)?%?/, m = /^\w+/, p = /%$/, t = a.fn.position;
        a.position = {
            scrollbarWidth: function () {
                ...
                var b = a(b || window), c = a.isWindow(b[0]);
                return {
                    element: b,
                    isWindow: c,
        ...
        a.fn.position = function (b) {
            ...
            var b = a.extend({}, b), e, p, s, z, C, q, r = a(b.of), u = a.position.getWithinInfo(b.within),
                v = a.position.getScrollInfo(u), y = (b.collision || "flip").split(" "), G = {};
            q = r;
            var Y = q[0];
            q = 9 === Y.nodeType ? {width: q.width(), height: q.height(), offset: {top: 0, left: 0}} : a.isWindow(Y) ? {
                width: q.width(),
                height: q.height(), offset: {top: q.scrollTop(), left: q.scrollLeft()}
            } : Y.preventDefault ? {
                width: 0,
                height: 0,
            ...
            C.top += e[1];
            return this.each(function () {
                var f, h, k = a(this), m = k.outerWidth(), q = k.outerHeight(),
                    t = parseInt(a.css(this, "marginLeft"), 10) || 0, L = parseInt(a.css(this, "marginTop"), 10) || 0,
                    Y = m + t + (parseInt(a.css(this, "marginRight"),
                        10) || 0) + v.width, A = q + L + (parseInt(a.css(this, "marginBottom"), 10) || 0) + v.height,
                    J = a.extend({}, C), ba = c(G.my, k.outerWidth(), k.outerHeight());
                ...
                b.using && (h = function (a) {
                    var c = z.left - J.left, f = c + p - m, h = z.top - J.top, e = h + s - q, l = {
        ...
        a.ui.position = {
            fit: {
                left: function (a, b) {
                    var c = b.within, f = c.isWindow ? c.scrollLeft : c.offset.left, h = c.width,
                        g = a.left - b.collisionPosition.marginLeft, c = f - g, e = g + b.collisionWidth - h - f;
                    ...
                    var c = b.within, f = c.isWindow ?
                        c.scrollTop : c.offset.top, h = b.within.height, g = a.top - b.collisionPosition.marginTop,
                        c = f - g, e = g + b.collisionHeight - h - f;
                ...
                left: function (a, b) {
                    var c = b.within, f = c.offset.left + c.scrollLeft, d = c.width,
                        h = c.isWindow ? c.scrollLeft : c.offset.left, e = a.left - b.collisionPosition.marginLeft,
                        c = e - h, k = e + b.collisionWidth - d - h, e = "left" === b.my[0] ? -b.elemWidth :
                    ...
                    var c = b.within, f = c.offset.top + c.scrollTop, d = c.height,
                        h = c.isWindow ? c.scrollTop : c.offset.top, e = a.top - b.collisionPosition.marginTop,
                        c = e - h, k = e + b.collisionHeight - d - h,
    ...
    (function (a) {
        a.widget("ui.draggable", a.ui.mouse, {
            ...
            _createHelper: function (e) {
                var c = this.options, e = a.isFunction(c.helper) ?
        ...
        a.ui.plugin.add("draggable", "connectToSortable", {
            start: function (e, c) {
                var b = a(this).data("ui-draggable"), d = b.options, g = a.extend({}, c, {item: b.element});
                b.sortables = [];
                ...
                var b = a(this).data("ui-draggable"), d = a.extend({}, c, {item: b.element});
                a.each(b.sortables, function () {
                    this.instance.isOver ? (this.instance.isOver = 0, b.cancelHelperRemoval = !0, this.instance.cancelHelperRemoval = !1, this.shouldRevert && (this.instance.options.revert = this.shouldRevert), this.instance._mouseStop(e), this.instance.options.helper = this.instance.options._helper, "original" === b.options.helper && this.instance.currentItem.css({
                        ...
                        !1, this.instance._trigger("deactivate", e, d))
                })
            }, drag: function (e, c) {
                var b = a(this).data("ui-draggable"), d = this;
                a.each(b.sortables, function () {
                    var g = !1, l = this;
                    ...
                    g ? (this.instance.isOver || (this.instance.isOver = 1, this.instance.currentItem = a(d).clone().removeAttr("id").appendTo(this.instance.element).data("ui-sortable-item", !0), this.instance.options._helper = this.instance.options.helper, this.instance.options.helper = function () {
                        return c.helper[0]
                    }, e.target = this.instance.currentItem[0], this.instance._mouseCapture(e,
        ...
        a.ui.plugin.add("draggable", "cursor", {
            start: function () {
                var e = a("body"), c = a(this).data("ui-draggable").options;
        ...
        a.ui.plugin.add("draggable", "opacity", {
            start: function (e, c) {
                var b = a(c.helper), d = a(this).data("ui-draggable").options;
        ...
        a.ui.plugin.add("draggable", "scroll", {
            start: function () {
                ...
                var c = a(this).data("ui-draggable"), b = c.options, d = !1;
        ...
        a.ui.plugin.add("draggable", "snap", {
            start: function () {
                var e = a(this).data("ui-draggable"), c = e.options;
                e.snapElements = [];
                ...
                var b, d, g, l, f, h, k, m, p, t, q = a(this).data("ui-draggable"),
                    r = q.options, v = r.snapTolerance, u = c.offset.left, y = u + q.helperProportions.width,
                    x = c.offset.top, B = x + q.helperProportions.height;
                ...
                }).left - q.margins.left)), !q.snapElements[p].snapping && (b || d || g || l || t) && q.options.snap.snap && q.options.snap.snap.call(q.element, e, a.extend(q._uiHash(), {snapItem: q.snapElements[p].item})),
                    q.snapElements[p].snapping = b || d || g || l || t) : (q.snapElements[p].snapping && q.options.snap.release && q.options.snap.release.call(q.element, e, a.extend(q._uiHash(), {snapItem: q.snapElements[p].item})), q.snapElements[p].snapping = !1)
            }
        });
        a.ui.plugin.add("draggable", "stack", {
            start: function () {
                var e, c = this.data("ui-draggable").options, c = a.makeArray(a(c.stack)).sort(function (b, c) {
    ...
    (function (a) {
        a.widget("ui.droppable", {
            ...
            _over: function (e) {
                var c = a.ui.ddmanager.current;
                if (c && (c.currentItem || c.element)[0] !== this.element[0]) if (this.accept.call(this.element[0], c.currentItem || c.element)) this.options.hoverClass &&
                this.element.addClass(this.options.hoverClass), this._trigger("over", e, this.ui(c))
            },
            _out: function (e) {
                var c = a.ui.ddmanager.current;
                if (c && (c.currentItem || c.element)[0] !== this.element[0]) if (this.accept.call(this.element[0], c.currentItem || c.element)) this.options.hoverClass && this.element.removeClass(this.options.hoverClass), this._trigger("out", e, this.ui(c))
            },
            _drop: function (e, c) {
                var b = c || a.ui.ddmanager.current, d = !1;
                if (!b || (b.currentItem || b.element)[0] === this.element[0]) return !1;
                this.element.find(":data(ui-droppable)").not(".ui-draggable-dragging").each(function () {
                    var c =
                        a.data(this, "ui-droppable");
                    if (c.options.greedy && !c.options.disabled && c.options.scope === b.options.scope && c.accept.call(c.element[0], b.currentItem || b.element) && a.ui.intersect(b, a.extend(c, {offset: c.element.offset()}), c.options.tolerance)) return d = !0, !1
                });
        ...
        a.ui.intersect = function (a, c, b) {
            ...
            var d = (a.positionAbs || a.position.absolute).left, g = d + a.helperProportions.width,
                l = (a.positionAbs || a.position.absolute).top, f = l + a.helperProportions.height, h = c.offset.left,
                k = h + c.proportions.width, m = c.offset.top, p = m + c.proportions.height;
            switch (b) {
                case "fit":
        ...
        a.ui.ddmanager = {
            current: null,
            droppables: {"default": []}, prepareOffsets: function (e, c) {
                var b, d, g = a.ui.ddmanager.droppables[e.options.scope] || [], l = c ? c.type : null,
                    f = (e.currentItem || e.element).find(":data(ui-droppable)").addBack();
                b = 0;
                a:for (; b < g.length; b++) if (!(g[b].options.disabled || e && !g[b].accept.call(g[b].element[0], e.currentItem || e.element))) {
                    for (d = 0; d < f.length; d++) if (f[d] === g[b].element[0]) {
    ...
    (function (a) {
        ...
        a.widget("ui.resizable", a.ui.mouse, {
            ...
            _create: function () {
                var b, c, g, e, f, h = this, k = this.options;
                ...
                if (this.handles.constructor === String) {
                    ...
                    this.handles = {};
                    for (c = 0; c < b.length; c++) g = a.trim(b[c]), f = "ui-resizable-" + g, e = a("<div class='ui-resizable-handle " + f + "'></div>"), e.css({zIndex: k.zIndex}), "se" === g && e.addClass("ui-icon ui-icon-gripsmall-diagonal-se"), this.handles[g] = ".ui-resizable-" + g, this.element.append(e)
                }
            ...
            _mouseStart: function (b) {
                ...
                /absolute/.test(f.css("position")) ? f.css({
                    ...
                    top: f.css("top"),
                    left: f.css("left")
                }) : f.is(".ui-draggable") && f.css({position: "absolute", top: c.top, left: c.left});
                this._renderProxy();
                ...
                this.sizeDiff = {
                    width: f.outerWidth() - f.width(), height: f.outerHeight() -
                    f.height()
                };
            ...
            _mouseDrag: function (b) {
                var c, g = this.helper, e = {};
                c = this.originalMousePosition;
                var f = this.position.top, h = this.position.left, k = this.size.width, m = this.size.height,
            ...
            _updateRatio: function (a) {
                var d = this.position, g = this.size, e = this.axis;
            ...
            _respectSize: function (a) {
                var d =
                        this._vBoundaries, g = this.axis, e = c(a.width) && d.maxWidth && d.maxWidth < a.width,
                    ...
                    m = this.originalPosition.left + this.originalSize.width, p = this.position.top + this.size.height,
                    t = /sw|nw|w/.test(g), g = /nw|ne|n/.test(g);
        ...
        a.ui.plugin.add("resizable", "animate", {
            stop: function (b) {
                var c = a(this).data("ui-resizable"), g = c.options, e = c._proportionallyResizeElements,
                    f = e.length && /textarea/i.test(e[0].nodeName),
                    h = f && a.ui.hasScroll(e[0], "left") ? 0 : c.sizeDiff.height, f =
                        {width: c.size.width - (f ? 0 : c.sizeDiff.width), height: c.size.height - h},
                ...
                c.element.animate(a.extend(f, k && h ? {top: k, left: h} : {}), {
                    duration: g.animateDuration, easing: g.animateEasing, step: function () {
                        var f = {
        ...
        a.ui.plugin.add("resizable", "containment", {
            start: function () {
                var b, c, g, l, f, h = a(this).data("ui-resizable"), k = h.element;
                ...
                if (k = g instanceof a ? g.get(0) : /parent/.test(g) ? k.parent().get(0) : g) h.containerElement = a(k), /document/.test(g) || g === document ? (h.containerOffset = {
                    ...
                    element: k, left: g.left, top: g.top, width: f,
                    height: l
                })
            }, resize: function (b) {
                ...
                var b = a(this).data("ui-resizable"), c = b.options, g = b.containerOffset, e = b.containerPosition,
                    f = b.containerElement, h = a(b.helper), k = h.offset(), m = h.outerWidth() - b.sizeDiff.width,
                    h = h.outerHeight() - b.sizeDiff.height;
                b._helper && (!c.animate && /relative/.test(f.css("position"))) && a(this).css({
                    left: k.left -
                    e.left - g.left, width: m, height: h
                });
        ...
        a.ui.plugin.add("resizable", "alsoResize", {
            start: function () {
                var b = a(this).data("ui-resizable").options, c = function (b) {
                    a(b).each(function () {
                        var b = a(this);
                ...
                var g = a(this).data("ui-resizable"), e = g.options, f = g.originalSize, h = g.originalPosition, k = {
                    ...
                    a(b).each(function () {
                        var b = a(this), h = a(this).data("ui-resizable-alsoresize"), g = {},
                            e = f && f.length ? f : b.parents(c.originalElement[0]).length ?
        ...
        a.ui.plugin.add("resizable", "ghost", {
            start: function () {
                var b = a(this).data("ui-resizable"), c = b.options, g = b.size;
                b.ghost = b.originalElement.clone();
                b.ghost.css({
                    opacity: 0.25, display: "block",
                    position: "relative", height: g.height, width: g.width, margin: 0, left: 0, top: 0
        ...
        a.ui.plugin.add("resizable", "grid", {
            resize: function () {
                var b = a(this).data("ui-resizable"),
                    c = b.options, g = b.size, e = b.originalSize, f = b.originalPosition, h = b.axis,
                    k = "number" === typeof c.grid ? [c.grid, c.grid] : c.grid, m = k[0] || 1, p = k[1] || 1,
                    t = Math.round((g.width - e.width) / m) * m, g = Math.round((g.height - e.height) / p) * p,
                    q = e.width + t, e = e.height + g, r = c.maxWidth && c.maxWidth < q,
                    v = c.maxHeight && c.maxHeight < e, u = c.minWidth && c.minWidth > q,
        ...
        a.widget("ui.selectable", a.ui.mouse, {
            ...
            _mouseStart: function (e) {
                ...
                this.options.disabled || (this.selectees = a(b.filter, this.element[0]), this._trigger("start", e), a(b.appendTo).append(this.helper), this.helper.css({
                    ...
                    b.startselected = !0;
                    !e.metaKey && !e.ctrlKey && (b.$element.removeClass("ui-selected"), b.selected =
                        !1, b.$element.addClass("ui-unselecting"), b.unselecting = !0, c._trigger("unselecting", e, {unselecting: b.element}))
                }), a(e.target).parents().addBack().each(function () {
                    var b, g = a.data(this, "selectable-item");
                    if (g) return b = !e.metaKey && !e.ctrlKey || !g.$element.hasClass("ui-selected"), g.$element.removeClass(b ? "ui-unselecting" : "ui-selected").addClass(b ? "ui-selecting" : "ui-unselecting"), g.unselecting = !b, g.selecting = b, (g.selected = b) ? c._trigger("selecting", e, {selecting: g.element}) : c._trigger("unselecting", e, {unselecting: g.element}),
                        !1
                }))
            },
            _mouseDrag: function (e) {
                ...
                if (!this.options.disabled) {
                    var c, b = this, d = this.options, g = this.opos[0], l = this.opos[1], f = e.pageX, h = e.pageY;
                    g > f && (c = f, f = g, g = c);
                    l > h && (c = h, h = l, l = c);
                    this.helper.css({left: g, top: l, width: f - g, height: h - l});
                    this.selectees.each(function () {
                        var c = a.data(this, "selectable-item"), m = !1;
                        c && c.element !== b.element[0] && ("touch" === d.tolerance ? m = !(c.left > f || c.right < g || c.top > h || c.bottom < l) : "fit" === d.tolerance && (m = c.left > g && c.right < f && c.top > l && c.bottom < h), m ? (c.selected && (c.$element.removeClass("ui-selected"),
                            ...
                            e, {unselecting: c.element}))), c.selected && (!e.metaKey && !e.ctrlKey && !c.startselected) && (c.$element.removeClass("ui-selected"), c.selected = !1, c.$element.addClass("ui-unselecting"), c.unselecting = !0, b._trigger("unselecting", e, {unselecting: c.element}))))
                    });
                    return !1
                }
            },
    ...
    (function (a) {
        ...
        a.widget("ui.sortable", a.ui.mouse, {
            version: "1.10.2", widgetEventPrefix: "sort", ready: !1, options: {
                appendTo: "parent",
                axis: !1,
                connectWith: !1,
                containment: !1,
                ...
                if (!this.options.axis || "y" !== this.options.axis) this.helper[0].style.left = this.position.left + "px";
                if (!this.options.axis || "x" !== this.options.axis) this.helper[0].style.top = this.position.top + "px";
                for (b = this.items.length - 1; 0 <= b; b--) if (d = this.items[b], g = d.item[0], (e = this._intersectsWithPointer(d)) && d.instance === this.currentContainer && g !== this.currentItem[0] &&
                    ...
                    if ("pointer" === this.options.tolerance || this._intersectsWithSides(d)) this._rearrange(c, d); else break;
                ...
                if (c) {
                    ...
                    if (this.options.revert) {
                        var d = this, g = this.placeholder.offset(), e = this.options.axis, f = {};
                ...
                var b = this._getItemsAsjQuery(c && c.connected), d = [], c = c ||
                    {};
                a(b).each(function () {
                ...
                var b = this.positionAbs.left, d = b + this.helperProportions.width, g = this.positionAbs.top,
                    e = g + this.helperProportions.height, f = a.left, h = f + a.width, k = a.top, m = k + a.height,
                    p = this.offset.click.top, t = this.offset.click.left;
                ...
                var b = "y" === this.options.axis || this.positionAbs.left + this.offset.click.left > a.left && this.positionAbs.left + this.offset.click.left < a.left + a.width,
                    ...
                    b = this._getDragVerticalDirection(), d = this._getDragHorizontalDirection();
                ...
                var b =
                    ...
                    d = this._getDragVerticalDirection(), g = this._getDragHorizontalDirection();
                ...
                var b, d, g, e = [], f = [], h = this._connectWith();
                if (h && c) for (c = h.length - 1; 0 <= c; c--) {
                    d = a(h[c]);
                ...
                if ((f = this._connectWith()) && this.ready) for (b =
                                                                      f.length - 1; 0 <= b; b--) {
                    g = a(f[b]);
                    for (d = g.length - 1; 0 <= d; d--) if ((e = a.data(g[d], this.widgetFullName)) && e !== this && !e.options.disabled) k.push([a.isFunction(e.options.items) ? e.options.items.call(e.element[0], c, {item: this.currentItem}) : a(e.options.items, e.element), e]), this.containers.push(e)
                }
                ...
                for (b = this.containers.length - 1; 0 <= b; b--) if (!a.contains(this.currentItem[0], this.containers[b].element[0])) if (this._intersectsWith(this.containers[b].containerCache)) {
                    if (!d ||
                ...
                if (d) if (1 === this.containers.length) this.containers[t].containerCache.over || (this.containers[t]._trigger("over", c, this._uiHash(this)), this.containers[t].containerCache.over = 1); else {
                    b = 1E4;
                    g = null;
        ...
        a.widget("ui.accordion", {
            ...
            _keydown: function (b) {
                if (!b.altKey && !b.ctrlKey) {
                    var c = a.ui.keyCode, e = this.headers.length, f = this.headers.index(b.target), h = !1;
                    switch (b.keyCode) {
                        case c.RIGHT:
                        case c.DOWN:
                            h =
            ...
            refresh: function () {
                var b = this.options;
                this._processPanels();
                if (!1 === b.active && !0 === b.collapsible || !this.headers.length) b.active =
                    !1, this.active = a();
            ...
            _refresh: function () {
                var b, c = this.options, l = c.heightStyle, f = this.element.parent(),
                ...
                this.headers.attr("role", "tab").each(function (b) {
                    var c = a(this), f = c.attr("id"), d = c.next(), e = d.attr("id");
            ...
            _eventHandler: function (b) {
                var c = this.options, e = this.active, f = a(b.currentTarget), h =
                    f[0] === e[0], k = h && c.collapsible, m = k ? a() : f.next(), p = e.next(),
            ...
            _toggle: function (b) {
                var c = b.newPanel, e = this.prevShow.length ? this.prevShow : b.oldPanel;
                ...
                c.attr({"aria-expanded": "true", "aria-hidden": "false"}).prev().attr({
                    "aria-selected": "true",
                    tabIndex: 0
                })
            },
            _animate: function (a, e, l) {
                var f, h, k, m = this, p = 0, t = a.length && (!e.length || a.index() < e.index()),
                    q = this.options.animate || {}, t = t && q.down || q, r = function () {
                        m._toggleComplete(l)
                    };
                "number" === typeof t && (k = t);
                "string" === typeof t && (h = t);
                ...
                e.animate(c, {
                    duration: k, easing: h, step: function (a, b) {
                        b.now = Math.round(a)
                    }
                });
                a.hide().animate(b, {
                    duration: k, easing: h, complete: r, step: function (a, b) {
                        b.now = Math.round(a);
    ...
    (function (a) {
        ...
        a.widget("ui.autocomplete", {
            ...
            pending: 0,
            _create: function () {
                var c, b, d, e = this.element[0].nodeName.toLowerCase(), l = "textarea" === e, e = "input" === e;
                ...
                this._on(this.element, {
                    keydown: function (f) {
                        if (this.element.prop("readOnly")) b = d = c = !0; else {
                            b = d = c = !1;
                            var h = a.ui.keyCode;
                            switch (f.keyCode) {
                                case h.PAGE_UP:
                        ...
                        if (c) c = !1, f.preventDefault(); else if (!b) {
                            var d = a.ui.keyCode;
                            switch (f.keyCode) {
                                case d.PAGE_UP:
                                    this._move("previousPage", f);
            ...
            _initSource: function () {
                ...
                a.isArray(this.options.source) ? (c = this.options.source, this.source = function (b, d) {
                    ...
                    this.source = function (c, e) {
                        d.xhr && d.xhr.abort();
                        d.xhr = a.ajax({
                            url: b, data: c, dataType: "json", success: function (a) {
                                e(a)
                            }, error: function () {
                                e([])
                            }
            ...
            _move: function (a, b) {
                if (this.menu.element.is(":visible")) if (this.menu.isFirstItem() && /^previous/.test(a) || this.menu.isLastItem() && /^next/.test(a)) this._value(this.term), this.menu.blur(); else this.menu[a](b); else this.search(null, b)
            },
            widget: function () {
    ...
    (function (a) {
        ...
        a.widget("ui.button", {
            ...
            _create: function () {
                ...
                var f = this, h = this.options, k = "checkbox" === this.type || "radio" === this.type,
                    m = !k ? "ui-state-active" : "";
            ...
            _resetButton: function () {
                if ("input" === this.type) this.options.label && this.element.val(this.options.label); else {
                    var b = this.buttonElement.removeClass("ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only"),
                        ...
                        d = this.options.icons, e = d.primary && d.secondary, g = [];
    ...
    (function (a, e) {
        ...
        function b(b) {
            return b.delegate("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a", "mouseout", function () {
                ...
                if (!a.datepicker._isDisabledDatepicker(l.inline ? b.parent()[0] : l.input[0])) a(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"), a(this).addClass("ui-state-hover"),
        ...
        a.extend(c.prototype, {
            ...
            _autoSize: function (a) {
                if (this._get(a, "autoSize") && !a.inline) {
                    var b, c, d, e, g = new Date(2009, 11, 20), l = this._get(a, "dateFormat");
            ...
            _enableDatepicker: function (b) {
                ...
                if (d.hasClass(this.markerClassName)) {
                    ...
                    if ("input" === c) b.disabled = !1, e.trigger.filter("button").each(function () {
                        ...
                        opacity: "1.0",
                        cursor: ""
                    }); else if ("div" === c || "span" === c) c = d.children("." + this._inlineClass), c.children().removeClass("ui-state-disabled"), c.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",
                        !1);
            ...
            _disableDatepicker: function (b) {
                ...
                if (d.hasClass(this.markerClassName)) {
                    ...
                    if ("input" === c) b.disabled = !0, e.trigger.filter("button").each(function () {
                        ...
                        opacity: "0.5",
                        cursor: "default"
                    }); else if ("div" === c || "span" === c) c = d.children("." + this._inlineClass), c.children().addClass("ui-state-disabled"), c.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled",
                        !0);
                    this._disabledInputs = a.map(this._disabledInputs, function (a) {
                        return a === b ? null : a
                    });
            ...
            _showDatepicker: function (b) {
                ...
                if (!(a.datepicker._isDisabledDatepicker(b) || a.datepicker._lastInput === b)) {
                    ...
                    if (!1 !== e && (d(c.settings, e), c.lastVal = null, a.datepicker._lastInput = b, a.datepicker._setDateFromField(c), a.datepicker._inDialog && (b.value = ""), a.datepicker._pos || (a.datepicker._pos = a.datepicker._findPos(b), a.datepicker._pos[1] += b.offsetHeight), g = !1, a(b).parents().each(function () {
                        ...
                        if (a.effects && a.effects.effect[e]) c.dpDiv.show(e, a.datepicker._get(c, "showOptions"), l); else c.dpDiv[e || "show"](e ? l : null);
            ...
            _updateDatepicker: function (b) {
                ...
                var c, d = this._getNumberOfMonths(b), e = d[1];
            ...
            _getBorders: function (a) {
                var b = function (a) {
                    return {thin: 1, medium: 2, thick: 3}[a] ||
                        a
                };
                return [parseFloat(b(a.css("border-left-width"))), parseFloat(b(a.css("border-top-width")))]
            },
            _checkOffset: function (b, c, d) {
                var e = b.dpDiv.outerWidth(), g = b.dpDiv.outerHeight(), l = b.input ? b.input.outerWidth() : 0,
            ...
            _hideDatepicker: function (b) {
                ...
                if (e && !(b && e !== a.data(b, "datepicker")) && this._datepickerShowing) {
                    ...
                    if (a.effects && (a.effects.effect[b] || a.effects[b])) e.dpDiv.hide(b, a.datepicker._get(e, "showOptions"), c, d); else e.dpDiv["slideDown" === b ? "slideUp" : "fadeIn" === b ? "fadeOut" : "hide"](b ? c : null, d);
                    b || d();
                    this._datepickerShowing = !1;
                    (b = this._get(e, "onClose")) && b.apply(e.input ? e.input[0] : null, [e.input ? e.input.val() : "", e]);
                    this._lastInput = null;
                    this._inDialog && (this._dialogInput.css({position: "absolute", left: "0", top: "-100px"}),
            ...
            _checkExternalClick: function (b) {
                if (a.datepicker._curInst) {
                    var b = a(b.target), c = a.datepicker._getInst(b[0]);
            ...
            _selectDate: function (b, c) {
                var d;
                d = a(b);
                var e = this._getInst(d[0]), c = null != c ? c : this._formatDate(e);
            ...
            parseDate: function (b, c, d) {
                ...
                var r = (d ? d.dayNames : null) || this._defaults.dayNames, v = (d ? d.monthNamesShort :
                    null) || this._defaults.monthNamesShort, u = (d ? d.monthNames : null) || this._defaults.monthNames,
                    y = d = -1, x = -1, B = -1, I = !1, s, z = function (a) {
                        ...
                        var e = -1, b = a.map(z(b) ? f : d, function (a, b) {
                            return [[b, a]]
                        }).sort(function (a, b) {
                ...
                for (e = 0; e < b.length; e++) if (I) "'" === b.charAt(e) && !z("'") ? I = !1 : M(); else switch (b.charAt(e)) {
                    case "d":
                        x = C("d");
                        break;
                    case "D":
            ...
            formatDate: function (a, b, c) {
                ...
                var d,
                    ...
                    c = (c ? c.monthNames : null) || this._defaults.monthNames, r = function (b) {
                ...
                if (b) for (d = 0; d < a.length; d++) if (y) "'" === a.charAt(d) && !r("'") ? y = !1 : u += a.charAt(d); else switch (a.charAt(d)) {
                    case "d":
                        u += v("d", b.getDate(), 2);
                        break;
                    case "D":
            ...
            _setDateFromField: function (a,
                ...
                if (a.input.val() !== a.lastVal) {
                    var c = this._get(a, "dateFormat"), d = a.lastVal = a.input ? a.input.val() : null,
                        e = this._getDefaultDate(a), g = e, l = this._getFormatConfig(a);
                    try {
            ...
            _setDate: function (a, b, c) {
                var d = !b, e = a.selectedMonth, g = a.selectedYear,
            ...
            _generateHTML: function (a) {
                ...
                var aa = this._getNumberOfMonths(a), E = this._get(a, "showCurrentAtPos");
                ...
                var A = 1 !== aa[0] || 1 !== aa[1],
                    ...
                    ba = this._getMinMaxDate(a,
                        "min"), ka = this._getMinMaxDate(a, "max"), E = a.drawMonth - E, P = a.drawYear;
                0 > E && (E += 12, P--);
                if (ka) {
            ...
            _generateMonthYearHeader: function (a, b, c, d, e, g, l, r) {
                var v, u, y, x = this._get(a, "changeMonth"), B = this._get(a, "changeYear"),
                    I = this._get(a, "showMonthAfterYear"), s = "<div class='ui-datepicker-title'>", z = "";
                if (g || !x) z += "<span class='ui-datepicker-month'>" + l[b] + "</span>"; else {
                    l = d && d.getFullYear() === c;
                    v = e && e.getFullYear() === c;
                ...
                I || (s += z + (g || !x || !B ? "&#xa0;" : ""));
                if (!a.yearshtml) if (a.yearshtml = "", g || !B) s += "<span class='ui-datepicker-year'>" + c + "</span>"; else {
            ...
            _adjustInstDate: function (a, b, c) {
                var d = a.drawYear + ("Y" === c ? b : 0), e = a.drawMonth +
                    ("M" === c ? b : 0), b = Math.min(a.selectedDay, this._getDaysInMonth(d, e)) + ("D" === c ? b : 0),
            ...
            _isInRange: function (a, b) {
                var c, d, e = this._getMinMaxDate(a, "min"), g = this._getMinMaxDate(a, "max"), l = null, r = null;
    ...
    (function (a) {
        ...
        a.widget("ui.dialog", {
            ...
            widget: function () {
                ...
                this._on(this.uiDialog, {
                    keydown: function (b) {
                        if (this.options.closeOnEscape && !b.isDefaultPrevented() && b.keyCode && b.keyCode === a.ui.keyCode.ESCAPE) b.preventDefault(), this.close(b); else if (b.keyCode === a.ui.keyCode.TAB) {
                            var c = this.uiDialog.find(":tabbable"), e = c.filter(":first"), c = c.filter(":last");
                            if ((b.target === c[0] || b.target === this.uiDialog[0]) && !b.shiftKey) e.focus(1), b.preventDefault(); else if ((b.target === e[0] || b.target === this.uiDialog[0]) && b.shiftKey) c.focus(1),
                                b.preventDefault()
                        }
                ...
                a.isEmptyObject(c) || a.isArray(c) && !c.length ? this.uiDialog.removeClass("ui-dialog-buttons") : (a.each(c, function (c,
                                                                                                                                        d) {
                    var e, h, d = a.isFunction(d) ? {click: d, text: c} : d, d = a.extend({type: "button"}, d);
                    e = d.click;
                    d.click = function () {
                ...
                this.uiDialog.draggable({
                    ...
                    handle: ".ui-dialog-titlebar", containment: "document", start: function (e, f) {
                ...
                var c = this, e = this.options, l = e.resizable, f = this.uiDialog.css("position"),
                ...
                "disabled" !== a && (this._super(a, c), "appendTo" === a && this.uiDialog.appendTo(this._appendTo()), "buttons" === a && this._createButtons(), "closeText" === a && this.uiDialogTitlebarClose.button({label: "" + c}), "draggable" ===
        ...
        !1 !== a.uiBackCompat && a.widget("ui.dialog", a.ui.dialog, {
            _position: function () {
                var b = this.options.position, c = [], e = [0, 0], l;
                if (b) {
    ...
    (function (a, e) {
        a.widget("ui.progressbar", {
            ...
            _refreshValue: function () {
                var c = this.options.value, b = this._percentage();
    ...
    (function (a) {
        a.widget("ui.slider", a.ui.mouse, {
            ...
            _createHandles: function () {
                var e, c;
                e = this.options;
                var b = this.element.find(".ui-slider-handle").addClass("ui-state-default ui-corner-all"), d = [];
            ...
            _mouseCapture: function (e) {
                var c, b, d, g, l, f = this, h = this.options;
                if (h.disabled) return !1;
            ...
            values: function (e, c) {
                var b, d, g;
                if (1 < arguments.length) this.options.values[e] = this._trimAlignValue(c), this._refreshValue(), this._change(null, e); else if (arguments.length) if (a.isArray(arguments[0])) {
            ...
            _trimAlignValue: function (a) {
                ...
                var c = 0 < this.options.step ? this.options.step : 1, b = (a - this._valueMin()) % c, a = a - b;
            ...
            _refreshValue: function () {
                var e, c, b, d, g, l = this.options.range, f = this.options, h = this,
                    k = !this._animateOff ? f.animate : !1, m = {};
                if (this.options.values && this.options.values.length) this.handles.each(function (b) {
                    ...
                    if ("max" === l && "horizontal" === this.orientation) this.range[k ? "animate" : "css"]({width: 100 - c + "%"}, {
                        queue: !1,
                        duration: f.animate
                    });
                    if ("min" === l && "vertical" === this.orientation) this.range.stop(1, 1)[k ? "animate" : "css"]({height: c + "%"}, f.animate);
                    if ("max" === l && "vertical" === this.orientation) this.range[k ? "animate" : "css"]({height: 100 - c + "%"}, {
                        queue: !1,
                        duration: f.animate
                    })
                }
    ...
    (function (a) {
        ...
        a.widget("ui.spinner", {
            ...
            _keydown: function (c) {
                var b = this.options, d = a.ui.keyCode;
                switch (c.keyCode) {
                    case d.UP:
        ...
        a.widget("ui.tabs", {
            ...
            _processTabs: function () {
                ...
                this.anchors.each(function (d, e) {
                    var h, k, m, p = a(e).uniqueId().attr("id"), t = a(e).closest("li"), q = t.attr("aria-controls");
            ...
            _eventHandler: function (b) {
                var c = this.options, d = this.active,
                    ...
                    p = m ? a() : this._getPanelForTab(e), t = !d.length ? a() : this._getPanelForTab(d),
            ...
            _toggle: function (b, c) {
                ...
                var k = this, m = c.newPanel, p = c.oldPanel;
                this.running = !0;
            ...
            load: function (b, d) {
                var b = this._getIndex(b), e = this, h = this.tabs.eq(b), k = h.find(".ui-tabs-anchor"),
                    m = this._getPanelForTab(h), p = {tab: h, panel: m};
            ...
            _ajaxSettings: function (b, c, d) {
                var e = this;
                return {
                    url: b.attr("href"), beforeSend: function (b, g) {
    ...
    (function (a) {
        ...
        a.widget("ui.tooltip", {
            version: "1.10.2", options: {
                ...
                var b = this, d = a(c ? c.target : this.element).closest(this.options.items);
                d.length && !d.data("ui-tooltip-id") && (d.attr("title") && d.data("ui-tooltip-title", d.attr("title")), d.data("ui-tooltip-open", !0), c && "mouseover" === c.type && d.parents().each(function () {
                    ...
                    c.attr("title") && (c.uniqueId(), b.parents[this.id] =
                        {element: this, title: c.attr("title")}, c.attr("title", ""))
                }), this._updateContent(d, c))
            }, _updateContent: function (a, b) {
                var d;
                d = this.options.content;
                var e = this, l = b ? b.type : null;
                ...
                if (d) if (l = this._find(b), l.length) l.find(".ui-tooltip-content").html(d);
                else {
                    b.is("[title]") && (c && "mouseover" === c.type ? b.attr("title", "") : b.removeAttr("title"));
                    l = this._tooltip(b);
                    var k = l.attr("id"), m = (b.attr("aria-describedby") || "").split(/\s+/);
                    m.push(k);
                ...
                var b = this, d = a(c ? c.currentTarget : this.element), e = this._find(d);
                if (!this.closing) {
                    clearInterval(this.delayedShow);
                    d.data("ui-tooltip-title") && d.attr("title", d.data("ui-tooltip-title"));
                    var l = d.data("ui-tooltip-id"), f = (d.attr("aria-describedby") || "").split(/\s+/),
                        l = a.inArray(l, f);
                    -1 !== l && f.splice(l, 1);
                ...
                var b = "ui-tooltip-" + e++, d = a("<div>").attr({
                    id: b,
                    role: "tooltip"
    ...
    (function (a, e) {
        ...
        var c = jQuery, b = function (a, b, c) {
                ...
                var b = h(), d = b._rgba = [], a = a.toLowerCase();
                r(f, function (c, e) {
                    var f, g = e.re.exec(a);
                    f = g && e.parse(g);
                    g = e.space || "rgba";
            ...
            }, m = {"byte": {floor: !0, max: 255}, percent: {max: 1}, degrees: {mod: 360, floor: !0}}, p = h.support = {},
            t = c("<p>")[0], q, r = c.each;
        ...
        h.fn = c.extend(h.prototype, {
            parse: function (a, e, f, g) {
                ...
                var l = this, m = c.type(a), p = this._rgba = [];
                ...
                var d = h(a), e = d._space(), f = k[e], g = 0 === this.alpha() ? h("transparent") :
                    this, l = g[f.cache] || f.to(g._rgba), p = l.slice(), d = d[f.cache];
                r(f.props, function (a, e) {
                    var f = e.idx, g = l[f], h = d[f], k = m[e.type] || {};
                    null !== h && (null === g ? p[f] = h : (k.mod && (h - g > k.mod / 2 ? g += k.mod : g - h > k.mod / 2 && (g -= k.mod)), p[f] = b((h - g) * c + g, e)))
                });
                return this[e](p)
            }, blend: function (a) {
                if (1 === this._rgba[3]) return this;
                var b = this._rgba.slice(), d = b.pop(), e = h(a)._rgba;
        ...
        r(k, function (a, d) {
            ...
            r(e, function (b, d) {
                h.fn[b] || (h.fn[b] = function (e) {
                    var f = c.type(e), g = "alpha" === b ?
                        this._hsla ? "hsla" : "rgba" : a, h = this[g](), k = h[d.idx];
        ...
        var v = function (b) {
            var c, d = b.ownerDocument.defaultView ?
                b.ownerDocument.defaultView.getComputedStyle(b, null) : b.currentStyle, e = {};
            if (d && d.length && d[0] && d[d[0]]) for (b = d.length; b--;) c = d[b], "string" === typeof d[c] && (e[a.camelCase(c)] = d[c]); else for (c in d) "string" === typeof d[c] && (e[c] = d[c]);
            return e
        }, u = ["add", "remove", "toggle"], y = {
            border: 1,
            borderBottom: 1,
            borderColor: 1,
            borderLeft: 1,
        ...
        a.effects.animateClass = function (b, c, d, e) {
            ...
            return this.queue(function () {
                var c = a(this), d = c.attr("class") || "", e, g = f.children ? c.find("*").addBack() : c,
                    g = g.map(function () {
                ...
                g = g.map(function () {
                    this.end =
                        v(this.el[0]);
                    var b = this.start, c = this.end, d = {}, e, f;
        ...
        a.extend(a.effects, {
            version: "1.10.2", save: function (a, b) {
                ...
                var c = {width: b.outerWidth(!0), height: b.outerHeight(!0), "float": b.css("float")},
                    d = a("<div></div>").addClass("ui-effects-wrapper").css({
                        fontSize: "100%", background: "transparent", border: "none",
                        margin: 0, padding: 0
                ...
                d = b.parent();
                "static" === b.css("position") ? (d.css({position: "relative"}), b.css({position: "relative"})) : (a.extend(c, {
                    position: b.css("position"),
        ...
        a.fn.extend({
            effect: function () {
                function b(d) {
                    ...
                    var g = a(this), h = c.complete, k = c.mode;
                    (g.is(":hidden") ?
                        "hide" === k : "show" === k) ? (g[k](), e()) : f.call(g[0], c, e)
                }

                var c = x.apply(this, arguments), d = c.mode, e = c.queue, f = a.effects.effect[c.effect];
    ...
    (function (a) {
        var e = /up|down|vertical/, c = /up|left|vertical|horizontal/;
        a.effects.effect.blind = function (b, d) {
            var g = a(this), l = "position top bottom left right height width".split(" "),
                f = a.effects.setMode(g, b.mode || "hide"), h = b.direction || "up", k = e.test(h),
                m = k ? "height" : "width", p = k ? "top" : "left", h = c.test(h), t = {}, q = "show" === f, r, v, u;
            ...
            u = parseFloat(r.css(p)) ||
                0;
            t[m] = q ? v : 0;
            h || (g.css(k ? "bottom" : "right", 0).css(k ? "top" : "left", "auto").css({position: "absolute"}), t[p] = q ? u : v + u);
            q && (r.css(m, 0), h || r.css(p, u + v));
            r.animate(t, {
                duration: b.duration, easing: b.easing, queue: !1, complete: function () {
                    "hide" === f && g.hide();
    ...
    (function (a) {
        a.effects.effect.bounce = function (e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "),
                g = a.effects.setMode(b, e.mode || "effect"), l = "hide" === g, f = "show" === g,
                h = e.direction || "up", g = e.distance, k = e.times || 5, m = 2 * k + (f || l ? 1 : 0),
                p = e.duration / m, t = e.easing, q = "up" === h || "down" === h ? "top" : "left",
                h = "up" === h || "left" === h, r, v, u = b.queue(), y = u.length;
            (f || l) && d.push("opacity");
            a.effects.save(b, d);
            b.show();
            ...
            f &&
            (v = {opacity: 1}, v[q] = 0, b.css("opacity", 0).css(q, h ? 2 * -g : 2 * g).animate(v, p, t));
            l && (g /= Math.pow(2, k - 1));
            v = {};
    ...
    (function (a) {
        a.effects.effect.clip = function (e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "),
                g = "show" === a.effects.setMode(b, e.mode || "hide"), l = "vertical" === (e.direction || "vertical"),
                f = l ? "height" : "width", l = l ? "top" : "left", h = {}, k, m;
            a.effects.save(b, d);
            b.show();
    ...
    (function (a) {
        a.effects.effect.drop = function (e, c) {
            var b = a(this), d = "position top bottom left right opacity height width".split(" "),
                g = a.effects.setMode(b, e.mode || "hide"), l = "show" === g, f = e.direction || "left",
                h = "up" === f || "down" === f ? "top" : "left", f = "up" === f || "left" === f ? "pos" : "neg",
                k = {opacity: l ? 1 : 0}, m;
            a.effects.save(b, d);
            b.show();
            a.effects.createWrapper(b);
    ...
    (function (a) {
        a.effects.effect.explode = function (e, c) {
            ...
            var d = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, g = d, l = a(this),
                f = "show" === a.effects.setMode(l, e.mode || "hide"),
                h = l.show().css("visibility", "hidden").offset(), k = Math.ceil(l.outerWidth() / g),
                m = Math.ceil(l.outerHeight() / d), p = [], t, q, r, v, u, y;
            for (t = 0; t < d; t++) {
                v = h.top + t * m;
                y = t - (d - 1) / 2;
                for (q = 0; q < g; q++) r = h.left + q * k, u = q - (g - 1) / 2, l.clone().appendTo("body").wrap("<div></div>").css({
                    position: "absolute",
                    visibility: "visible", left: -q * k, top: -t * m
    ...
    (function (a) {
        a.effects.effect.fade = function (e, c) {
            var b = a(this), d = a.effects.setMode(b, e.mode || "toggle");
    ...
    (function (a) {
        a.effects.effect.fold = function (e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "),
                g = a.effects.setMode(b, e.mode || "hide"), l = "show" === g, f = "hide" === g, g = e.size || 15,
                h = /([0-9]+)%/.exec(g), k = !!e.horizFirst, m = l !== k,
                p = m ? ["width", "height"] : ["height", "width"], t = e.duration / 2, q, r = {}, v = {};
            a.effects.save(b, d);
            b.show();
    ...
    (function (a) {
        a.effects.effect.highlight = function (e, c) {
            var b = a(this), d = ["backgroundImage", "backgroundColor", "opacity"],
                g = a.effects.setMode(b, e.mode || "show"), l = {backgroundColor: b.css("backgroundColor")};
            "hide" === g && (l.opacity = 0);
            a.effects.save(b, d);
            b.show().css({backgroundImage: "none", backgroundColor: e.color || "#ffff99"}).animate(l, {
                queue: !1,
                duration: e.duration,
                easing: e.easing,
                complete: function () {
    ...
    (function (a) {
        a.effects.effect.pulsate = function (e, c) {
            var b = a(this), d = a.effects.setMode(b, e.mode || "show"), g = "show" === d, l = "hide" === d,
                d = 2 * (e.times || 5) + (g || "hide" === d ? 1 : 0), f = e.duration / d, h = 0, k = b.queue(),
                m = k.length;
    ...
    (function (a) {
        a.effects.effect.puff = function (e, c) {
            var b = a(this), d = a.effects.setMode(b, e.mode || "hide"), g = "hide" === d,
                l = parseInt(e.percent, 10) || 150, f = l / 100,
        ...
        a.effects.effect.scale = function (e, c) {
            ...
            d.to = {
                ...
                l, outerHeight: k.outerHeight * m, outerWidth: k.outerWidth * l
            };
        ...
        a.effects.effect.size = function (e, c) {
            ...
            var p = ["width", "height", "overflow"], t = ["fontSize"],
                q = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], r = ["borderLeftWidth",
                    "borderRightWidth", "paddingLeft", "paddingRight"], v = a.effects.setMode(k, e.mode || "effect"),
                u = e.restore || "effect" !== v, y = e.scale || "both";
            h = e.origin || ["middle", "center"];
            var x = k.css("position"), B = u ? m : f, I = {height: 0, width: 0, outerHeight: 0, outerWidth: 0};
            "show" === v && k.show();
            ...
            if ("content" === y || "both" === y) q = q.concat(["marginTop", "marginBottom"]).concat(t), r = r.concat(["marginLeft", "marginRight"]), p = m.concat(q).concat(r), k.find("*[width]").each(function () {
                var c = a(this), f = c.height(), h = c.width(), k = c.outerHeight(),
                    m = c.outerWidth();
                ...
                complete: function () {
                    ...
                    u || ("static" === x ? k.css({
                        ...
                        k.css(b, function (b, c) {
                            var d = parseInt(c, 10), e = a ? k.to.left : k.to.top;
    ...
    (function (a) {
        a.effects.effect.shake = function (e, c) {
            var b = a(this), d = "position top bottom left right height width".split(" "),
                g = a.effects.setMode(b, e.mode || "effect"), l = e.direction || "left", f = e.distance || 20,
                h = e.times || 3, k = 2 * h + 1, m = Math.round(e.duration / k),
                p = "up" === l || "down" === l ? "top" : "left", t = "up" === l || "left" === l, l = {}, q = {}, r = {},
                v = b.queue(), u = v.length;
            a.effects.save(b, d);
            b.show();
            a.effects.createWrapper(b);
            l[p] = (t ? "-=" : "+=") + f;
    ...
    (function (a) {
        a.effects.effect.slide = function (e, c) {
            var b = a(this), d = "position top bottom left right width height".split(" "),
                g = a.effects.setMode(b, e.mode || "show"), l = "show" === g, f = e.direction || "left",
                h = "up" === f || "down" === f ? "top" : "left", f = "up" === f || "left" === f, k, m = {};
            a.effects.save(b, d);
            b.show();
            ...
            b.animate(m, {
                ...
                easing: e.easing, complete: function () {
                    "hide" === g && b.hide();
                    a.effects.restore(b, d);
                    a.effects.removeWrapper(b);
                    c()
    ...
    (function (a) {
        a.effects.effect.transfer = function (e, c) {
            var b = a(this), d = a(e.to), g = "fixed" === d.css("position"), l = a("body"), f = g ? l.scrollTop() : 0,
                l = g ? l.scrollLeft() : 0, h = d.offset(),
                d = {top: h.top - f, left: h.left - l, height: d.innerHeight(), width: d.innerWidth()}, h = b.offset(),
    ...
    var messenger = function (a) {
        ...
        var e = [], c = Math.round(1E9 * Math.random()) % 1E9, b = function (b) {
            if (a.isWebWorker || !("*" !== a.origin && a.origin !== b.origin)) try {
                var c = JSON.parse(b.data), g = c.type, k = c.data, m = c.id;
    ...
    function createStars(a) {
        var e = a.size || 32, c = a.prefix || "", b = a.hasText || void 0 === a.hasText,
        ...
        for (var h = [], d = 0; d < a.stars; ++d) (function (d) {
            var k = $("<div class='" + c + "star'></div>").css({
                width: e + "px", height: e + "px", backgroundSize: 2 *
                e + "px " + e + "px"
            }).appendTo(g);
        ...
        if (l) for (var k = Math.floor(l), m = l - k, d = 0; d < h.length; ++d) if (d < k) h[d].addClass(c + "selected"); else if (d === k && 0 !== m) {
            h[d].addClass(c + "partial");
            var p = 0.5 > m ? 0.5 * Math.sin(m * Math.PI) : 1 - 0.5 * Math.sin((1 - m) * Math.PI),
                p = Math.round(p * e), t = e - p, q = 2 * e + "px " + e + "px", r = -e + "px 0px", v = -p + "px 0px";
    ...
    (function () {
        ...
        "function" !== typeof JSON.stringify && (JSON.stringify = function (a, b, d) {
            var e;
            l = g = "";
            if ("number" === typeof d) for (e = 0; e < d; e += 1) l += " "; else "string" === typeof d && (l = d);
        ...
        "function" !== typeof JSON.parse && (JSON.parse = function (a, c) {
            ...
            if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
                    "]").replace(/(?:^|:|,)(?:\s*\[)+/g, ""))) return e = eval("(" + a + ")"), "function" === typeof c ? d({"": e}, "") : e;
    ...
    var api = function () {
                ...
                return function (b) {
                    return function () {
                        for (var c, d, e = b, f = 0; f < arguments.length; ++f) {
                            ...
                            if (!c && "object" === h) c = arguments[f]; else if (c) break; else e = e.replace(RegExp("\\$" + f, "g"), arguments[f])
                        }
                        c = c || {};
                        ...
                        g ? g(e, a, c, function (a) {
                            ...
                            url: e,
                            type: a, async: !0, dataType: "json", data: c, success: function (a) {
                                d && d(a)
                            }, error: function () {
                                d && d(!1)
                            }
        ...
        if (!("withCredentials" in new XMLHttpRequest) && !a) {
            ...
            window.addEventListener("message", function (a) {
                if (a.origin === SECURE_API_HOST) if ("yumprint-proxy-ready" === a.data) k.set(); else try {
        ...
        d.registerYumprint = function (a, b) {
            ...
            ka({
                email_address: a.email, password: a.password, first_name: a.firstName,
                last_name: a.lastName, gender: a.gender, photo: a.photo, type: a.type, value: a.value
            }, m(b))
        };
        ...
        var H = b(SECURE_API_HOST + "/feed/home/"), xb = b(SECURE_API_HOST + "/user/$0/feed/home/");
        d.home = function (a, b) {
    ...
    function loadReviews(a, e, c) {
        api.getReview(e, function (b) {
            if (b) for (var d = 0; d < b.length; ++d) (function (b) {
    ...
    function initRecipe(a) {
        ...
        a.find(".blog-yumprint-print").click(function () {
            ...
            c = window.open("");
            b = JSON.stringify(b);
            c.document.write("<!DOCTYPE html><html><head><title>Print - " + a.find(".blog-yumprint-recipe-title").text() + "</title><link href='http://fonts.googleapis.com/css?family=Lato:300,700' rel='stylesheet' type='text/css'><link rel='stylesheet' type='text/css' media='all' href='" + window.yumprintRecipePlugin + "/css/print.css' /><link rel='stylesheet' type='text/css' media='print' href='" + window.yumprintRecipePlugin +
        ...
        a.find(".blog-yumprint-nutrition-bar").click(function () {
            ...
            showDialog({
                id: "blog-yumprint-nutrition-card", show: function (a) {
        ...
        if (window.yumprintRecipeDisabled) a.find(".blog-yumprint-stars-reviews, .blog-yumprint-save, .blog-yumprint-print").remove(); else {
            var c = a.attr("yumprintrecipe"), e = a.find(".blog-yumprint-stars-reviews");
            if (e.is(":visible")) {
                var b = e.attr("color"), d = e.attr("highlightcolor"), g = e.attr("emptycolor"),
                    l = parseFloat(e.attr("rating")), f = parseInt(e.attr("count"));
            ...
            a.find(".blog-yumprint-save").click(function () {
                showDialog({
                    width: 700, height: 468, show: function (a) {
    ...
    $(function () {
        window.yumprintRecipeDisabled || messenger().addHandler("new review", function (a) {
            $(".blog-yumprint-recipe[yumprintrecipe='" + a.id + "']").each(function () {
                var e = $(this), c = e.find(".blog-yumprint-stars-reviews");
                if (c.is(":visible")) {
                    var b = c.attr("color"), d = c.attr("highlightcolor"), g = c.attr("emptycolor");
